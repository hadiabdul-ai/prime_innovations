...
export const ButtonsCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "w-full rounded-xl dark:bg-transparent dark:border-white/[0.2] hover:border-neutral-200 group/btn overflow-hidden relative flex items-center justify-center",
        className
      )}
    >
