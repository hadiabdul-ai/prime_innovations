  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <meta property="og:image" content="https://www.primeinnovations.ca/images/logo-full.png" />
        <meta property="og:url" content="https://www.primeinnovations.ca/" />
        <meta property="og:type" content="website" />

        {/* Apple Meta Tags */}
        <link rel="apple-touch-icon" href="https://www.primeinnovations.ca/images/logo-full.png" />
